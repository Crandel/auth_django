...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HomeBanner.banner_link'
        db.add_column(u'home_homebanner', 'banner_link',
                      self.gf('django.db.models.fields.URLField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HomeBanner.banner_link'
        db.delete_column(u'home_homebanner', 'banner_link')
    ...
    models = {
        ...
        u'home.homebanner': {
            ...
            'banner_link': ('django.db.models.fields.URLField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
