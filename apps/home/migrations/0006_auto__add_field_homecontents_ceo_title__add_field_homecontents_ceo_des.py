...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HomeContents.ceo_title'
        db.add_column(u'home_homecontents', 'ceo_title',
                      self.gf('django.db.models.fields.CharField')(default='trtg', max_length=100),
                      keep_default=False)

        # Adding field 'HomeContents.ceo_desc'
        db.add_column(u'home_homecontents', 'ceo_desc',
                      self.gf('django.db.models.fields.TextField')(default='sdef'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HomeContents.ceo_title'
        db.delete_column(u'home_homecontents', 'ceo_title')

        # Deleting field 'HomeContents.ceo_desc'
        db.delete_column(u'home_homecontents', 'ceo_desc')
    ...
    models = {
        ...
        u'home.homecontents': {
            ...
            'ceo_desc': ('django.db.models.fields.TextField', [], {}),
