...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Events.sort_order'
        db.add_column(u'newsevents_events', 'sort_order',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Events.sort_order'
        db.delete_column(u'newsevents_events', 'sort_order')
