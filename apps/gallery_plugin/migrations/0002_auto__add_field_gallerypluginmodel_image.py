...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GalleryPluginModel.image'
        db.add_column(u'gallery_plugin_gallerypluginmodel', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(default='grt', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GalleryPluginModel.image'
        db.delete_column(u'gallery_plugin_gallerypluginmodel', 'image')
