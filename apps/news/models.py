...
class NewsModel(models.Model):
    ...
    created_at = models.DateField(_('Last Date'), max_length=255, auto_now_add=True)
...
class NewsInfo(models.Model):
    ...
    header_image = models.ImageField(_('Image'), max_length=255, upload_to="news/image_info/", null=True)

    def __unicode__(self):
        return self.title

    class Meta:
        verbose_name = _('NewsInfo')
        verbose_name_plural = _('NewsInfo`s')
