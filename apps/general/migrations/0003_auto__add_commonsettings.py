...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CommonSettings'
        db.create_table(u'general_commonsettings', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'], unique=True)),
            ('logo_icon', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('logo_url', self.gf('django.db.models.fields.URLField')(max_length=200)),
        ))
        db.send_create_signal(u'general', ['CommonSettings'])


    def backwards(self, orm):
        # Deleting model 'CommonSettings'
        db.delete_table(u'general_commonsettings')
