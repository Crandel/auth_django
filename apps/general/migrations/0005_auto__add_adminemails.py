...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AdminEmails'
        db.create_table(u'general_adminemails', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'], unique=True)),
            ('con_email', self.gf('django.db.models.fields.EmailField')(max_length=100)),
            ('career_email', self.gf('django.db.models.fields.EmailField')(max_length=100)),
        ))
        db.send_create_signal(u'general', ['AdminEmails'])


    def backwards(self, orm):
        # Deleting model 'AdminEmails'
        db.delete_table(u'general_adminemails')
