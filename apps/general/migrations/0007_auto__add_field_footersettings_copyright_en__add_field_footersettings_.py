...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FooterSettings.copyright_en'
        db.add_column(u'general_footersettings', 'copyright_en',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FooterSettings.copyright_ar'
        db.add_column(u'general_footersettings', 'copyright_ar',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FooterSettings.copyright_en'
        db.delete_column(u'general_footersettings', 'copyright_en')

        # Deleting field 'FooterSettings.copyright_ar'
        db.delete_column(u'general_footersettings', 'copyright_ar')
