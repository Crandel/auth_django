...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vacancy.position_en'
        db.add_column(u'careers_vacancy', 'position_en',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Vacancy.position_ar'
        db.add_column(u'careers_vacancy', 'position_ar',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Vacancy.requirement_en'
        db.add_column(u'careers_vacancy', 'requirement_en',
                      self.gf('ckeditor.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Vacancy.requirement_ar'
        db.add_column(u'careers_vacancy', 'requirement_ar',
                      self.gf('ckeditor.fields.RichTextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vacancy.position_en'
        db.delete_column(u'careers_vacancy', 'position_en')

        # Deleting field 'Vacancy.position_ar'
        db.delete_column(u'careers_vacancy', 'position_ar')

        # Deleting field 'Vacancy.requirement_en'
        db.delete_column(u'careers_vacancy', 'requirement_en')

        # Deleting field 'Vacancy.requirement_ar'
        db.delete_column(u'careers_vacancy', 'requirement_ar')
