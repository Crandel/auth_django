...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VacancyApply'
        db.create_table(u'careers_vacancyapply', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'])),
            ('vacancy', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['careers.Vacancy'])),
            ...
            ('nationality', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['careers.Nationality'])),
            ('address', self.gf('django.db.models.fields.TextField')()),
            ('phone', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=255)),
            ('cv', self.gf('django.db.models.fields.files.FileField')(max_length=255)),
        ))
        db.send_create_signal(u'careers', ['VacancyApply'])

        # Adding model 'Nationality'
        db.create_table(u'careers_nationality', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nationality', self.gf('django.db.models.fields.CharField')(max_length=1000)),
        ))
        db.send_create_signal(u'careers', ['Nationality'])


    def backwards(self, orm):
        # Deleting model 'VacancyApply'
        db.delete_table(u'careers_vacancyapply')

        # Deleting model 'Nationality'
        db.delete_table(u'careers_nationality')
