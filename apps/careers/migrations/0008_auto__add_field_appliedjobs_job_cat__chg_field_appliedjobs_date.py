...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppliedJobs.job_cat'
        db.add_column(u'careers_appliedjobs', 'job_cat',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['careers.JobCategory'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'AppliedJobs.job_cat'
        db.delete_column(u'careers_appliedjobs', 'job_cat_id')
