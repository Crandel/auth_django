...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ContactUs.email'
        db.alter_column(u'contactus_contactus', 'email', self.gf('django.db.models.fields.EmailField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'ContactUs.email'
        db.alter_column(u'contactus_contactus', 'email', self.gf('django.db.models.fields.CharField')(max_length=100))
