...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ContactUs.enquiry'
        db.alter_column(u'contactus_contactus', 'enquiry', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'ContactUs.enquiry'
        db.alter_column(u'contactus_contactus', 'enquiry', self.gf('ckeditor.fields.RichTextField')())
