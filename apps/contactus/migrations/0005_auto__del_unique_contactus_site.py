...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ContactUs', fields ['site']
        db.delete_unique(u'contactus_contactus', ['site_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'ContactUs', fields ['site']
        db.create_unique(u'contactus_contactus', ['site_id'])
