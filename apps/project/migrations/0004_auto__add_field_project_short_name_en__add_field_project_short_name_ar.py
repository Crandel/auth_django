...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.short_name_en'
        db.add_column(u'project_project', 'short_name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.short_name_ar'
        db.add_column(u'project_project', 'short_name_ar',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.short_name_en'
        db.delete_column(u'project_project', 'short_name_en')

        # Deleting field 'Project.short_name_ar'
        db.delete_column(u'project_project', 'short_name_ar')
